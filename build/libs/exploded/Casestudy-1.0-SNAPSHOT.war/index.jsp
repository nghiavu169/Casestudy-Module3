...
<%--            <div class="col-sm-1">--%>
<%--                <ul>--%>
<%--                    <li class="menu-left"><a href="#">Trang chủ</a></li>--%>
<%--                    <li class="menu-left"><a href="#">Dịch vụ</a></li>--%>
<%--                    <li class="menu-left"><a href="#">Sản phẩm</a></li>--%>
<%--                    <li class="menu-left"><a href="#">Tin tức</a></li>--%>
<%--                    <li class="menu-left"><a href="#">Diễn đàn</a></li>--%>
<%--                    <li class="menu-left"><a href="#">Liên hệ</a></li>--%>
<%--                </ul>--%>
<%--            </div>--%>
            <div class="col-sm-12">
