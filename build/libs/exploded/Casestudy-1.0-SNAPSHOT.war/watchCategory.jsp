...
<div style="height: auto; width: 100%">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="background-color: black">
        <a class="navbar-brand" href="/watches"><img style="width: 50px;height: 50px"
        ...
        <div class="collapse navbar-collapse" id="navbarColor02">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="/watches?action=brand&type=applewatch">Apple Watch</a>
            ...
            <a class="nav-link fa fa-shopping-cart fa-2x" href="/cart"><span style="padding: 10px; font-size: 20px"
                                                                             class="badge badge-dark">${quantity}</span></a>
        </div>
    </nav>
    <!-- navbar -->
                            ...
                            <c:if test="${watch.getBrand_id() == brand.getId()}">
                                <div class="col-sm-4">
                                    <div class="card" style="width:19rem; ">
                                        <a href="/watches?action=showDetails&id=${watch.getId()}"><img
                                                class="card-img-top"
                                                src="${watch.getImg()}"
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3 col-lg-4 col-xl-3">
                ...
                <p class="mb-0">
                    V&NC là một nhà sản xuất đồng hồ xa xỉ của Thụy Sĩ được thành lập vào năm 1980 bởi Carlo Crocco.
                    Công ty hoạt động như một công ty con thuộc sở hữu của LVMH của Pháp.
                </p>
            </div>
